...
#create class - InternshipChecker
class InternshipChecker(ttk.Frame, object):
    def __init__(self, parent):
        ...
        self.widgets_frame.grid(
            row=5, column=0, padx=10, pady=(30, 10), sticky="nsew", rowspan=6
        )
...
# --------------------------------------------------------------------
    ...
    def check_eligibility(self):
        try:
            ...
            first_name = self.fname.get().capitalize()
            last_name = self.lname.get().capitalize()
